...
function initialize() {
  ...
  demo_text.innerHTML = "This is a demo. Full site coming soon!"
  demo_text.index = 3;
  demo_text.className = "demo_text";
  ...
  map.controls[google.maps.ControlPosition.BOTTOM_CENTER].push(demo_text);
